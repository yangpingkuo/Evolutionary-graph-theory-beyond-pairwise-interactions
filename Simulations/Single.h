...
Simulator::Simulator(string input_name, string output_name) {
    ...
    file << "# Input graph : " << input_name << endl;
    file << "# \"Selection\"\t \"# of extinction\" \t \"# of fixation\"\t \"Extinction time\" \t \"Fixation time\" \t \"Runtime\"" << endl;
...
// Simulate 1 birth-death processes
...
// Simulate 1 death-birth process on network
